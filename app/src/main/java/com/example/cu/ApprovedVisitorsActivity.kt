...
class ApprovedVisitorsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_approved_visitors)
        ...
        departmentAdapter = DepartmentAdapter(departments) { department ->
            ...
            val intent = Intent(this, Chief_Dept_Approved::class.java)
        ...
        query.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (visitorSnapshot in snapshot.children) {
                    ...
                    if ((departmentName != null) && (approved == "true")) {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@ApprovedVisitorsActivity, "Failed to fetch department data", Toast.LENGTH_SHORT).show()
            }
        })
    }
