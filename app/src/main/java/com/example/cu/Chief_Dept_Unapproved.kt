...
class Chief_Dept_Unapproved : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_chief_dept_unapproved)
    ...
    private fun fetchVisitorData(department: String) {
        ...
        query.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@Chief_Dept_Unapproved, "Failed to fetch visitor data", Toast.LENGTH_SHORT).show()
            }
        })
    }
}
